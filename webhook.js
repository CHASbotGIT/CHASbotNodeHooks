...
console.log(GOOGLE_PRIVATE_KEY_ORIG);
const GOOGLE_PRIVATE_KEY_MODIFIED = process.env.GOOGLE_PRIVATE_KEY_ORIG.replace(/\\n/g, '\n');
console.log(GOOGLE_PRIVATE_KEY_MODIFIED);
