...
function playTopTrumps(eventTT,playTT){ // IN DEV
  ...
  if (playTT.length == 0) {
    ...
    console.log("DEBUG [playTopTrumps]> Comparison character " + HERO_ARRAY[16][0] + ", with value: " + oldScore);
    ...
    if (chicken_dinner){
      ...
      console.log("DEBUG [playTopTrumps]> Winning character " + HERO_ARRAY[16][0] + ", pick category, winning value: " + newScore);
      //  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      // [ WINNING TRUMPS CHARACTER PICKED - PICK AGAIN ]
      // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    } else {
      console.log("DEBUG [playTopTrumps]> Losing character " + HERO_ARRAY[16][0] + ", GAME OVER, losing value: " + newScore);
